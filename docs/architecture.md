# memwire Architecture Ã¢â‚¬â€ Figure 1

![memwire architecture: client, orchestration, storage and governance layers](architecture.svg)
...
This figure is **Figure 1** of the memwire technical paper. Suggested in-prose references:

- *"The full memwire runtime is shown in Figure 1."*
