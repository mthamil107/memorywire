"""The :class:`MemoryRouter` â€” a :class:`memwire.store.MemoryStore` composed of N child stores.

The router is the centrepiece of memwire's "any-backend" promise (spec Â§5). It
...
itself satisfies the :class:`memwire.store.MemoryStore` Protocol, routers can
...
* Graph-hop boost dispatches to stores implementing the
  ...
  no store declares :attr:`memwire.store.Capability.GRAPH`.
"""
