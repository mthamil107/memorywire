"""FSM-backed procedural-memory backend for AMP (spec section 7).
...
* :class:`Procedure` — a JSON-friendly dataclass mirroring the
  ...
  :file:`src/amp/schemas/types/procedural.json`. Roundtrips losslessly via
...
# The pytransitions wildcard idiom. AMP v0 spec §7 (Editor's note) names
