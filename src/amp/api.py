"""The :class:`Memory` facade — the public ergonomic entry point for AMP.

This module is intentionally a *thin* wrapper. All real fan-out logic lives
in :class:`amp.router.MemoryRouter`; this class translates ergonomic
...
class Memory:
    ...
    agent_id:
        ...
        this instance. Required because every AMP request carries an
        ``agent_id``.
    stores:
