"""Pydantic v2 models for the Agent Memory Protocol (AMP) v0.

This module mirrors the JSON Schemas under :mod:`amp.schemas`. Every operation
...
# All AMP models share the same pydantic config: forward-compat extras, alias
...
class RememberRequest(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/remember.json`.
    """
...
class RecallRequest(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/recall.json`.
    """
...
class ForgetRequest(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/forget.json`.
...
class MergeRequest(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/merge.json`.
    """
...
class ExpireRequest(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/expire.json`.
    """
...
class RememberResponse(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/remember.response.json`.
    """
...
class RecallHit(BaseModel):
    ...
    :file:`src/amp/schemas/operations/recall.response.json`.
...
class RecallResponse(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/recall.response.json`.
    """
...
class ForgetStoreResult(BaseModel):
    ...
    :file:`src/amp/schemas/operations/forget.response.json`.
    """
...
class ForgetResponse(BaseModel):
    ...
    Mirrors :file:`src/amp/schemas/operations/forget.response.json` (the
...
# Memory *facade* class to ``amp.__init__``; this name is the wire-format
...
class ProcedureTransition(BaseModel):
    ...
    :file:`src/amp/schemas/types/procedural.json`. Extra keys are allowed
...
class ProcedureSpec(BaseModel):
    ...
    Mirrors the ``content`` object of :file:`src/amp/schemas/types/procedural.json`.
    """
